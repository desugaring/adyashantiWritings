    ...
    switch (self.theme) {
        case ASColorThemeTypeBlack:
            return @{ ASColorThemeKeyParagraph: [UIColor whiteColor],
                      ...
                      ASColorThemeKeyBackgroundLight: [UIColor colorWithRed:30.0/255.0 green:30.0/255.0 blue:30.0/255.0 alpha:1.0],
        ...
        case ASColorThemeTypeWhite:
            return @{ ASColorThemeKeyParagraph: [UIColor blackColor],
                      ...
                      ASColorThemeKeyBackgroundLight: [UIColor colorWithRed:250.0/255.0 green:250.0/255.0 blue:250.0/255.0 alpha:1.0],
        ...
        case ASColorThemeTypeBeige:
              return @{ ASColorThemeKeyParagraph: [UIColor colorWithRed:80.0/255.0 green:50.0/255.0 blue:27.0/255.0 alpha:1.0],
                        ...
                        ASColorThemeKeyBackgroundLight: [UIColor colorWithRed:252.0/255.0 green:251.0/255.0 blue:231.0/255.0 alpha:1.0],
